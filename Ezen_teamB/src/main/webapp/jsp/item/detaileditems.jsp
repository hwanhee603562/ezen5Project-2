...
<body>
	...
	<div class="detailedItemsWrap">
		...
		<div class="mainInformation">
			<div class="mainInfoLeft"><!-- 좌측 구역 -->

				<div class="outputTradeMethod">
					<!-- 거래방식, 판매가격, 안전결제 사용여부 -->
					...
					<div class="caution">
						...
						<div class="cautionComment">
							“가지가지” 상점의 거래상품들에 대하여 통신판매중개자로서<br> 거래 당사자가 아니며 판매 회원과 구매 회원
							간의 상품거래 정보 및<br> 거래에 관여하지 않고, 어떠한 의무와 책임도 부담하지 않습니다.
						</div>
					</div>
